...
export const metadata: Metadata = {
  ...
  icons: {
    icon: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 42 32'%3E%3Crect width='42' height='32' fill='%230b0b0f'/%3E%3Cg fill='none' stroke='%23c9a96a' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'%3E%3Cpath d='M2 3 13.6 29 25.2 3'/%3E%3Cpath d='M16.8 3 28.4 29 40 3'/%3E%3C/g%3E%3C/svg%3E",
  },
};
